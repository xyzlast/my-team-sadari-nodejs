...
module.exports.listByMonth = function(year, month, func) {
  var query = {
                deleted: false,
                date: {
...
module.exports.listByDate = function(year, month, day, func) {
  var query = {
                deleted: false,
                date: {
...
module.exports.add = function(game, gameResults, func) {
  var winnerId = '';
...
module.exports.update = function(id, game, gameResults, func) {
  var winnerId = '';
  gameResults.forEach(function(gameResult) {
    if(gameResult.number == game.number) {
      winnerId = gameResult.playerId;
